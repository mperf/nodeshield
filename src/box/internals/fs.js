...
if (hostModule.promises) {
  ...
  hostFsModule.promises = Object.freeze({
    readFile: function() { const context = getContext(); if (!isReadAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.readFile()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.readFile, p, arguments); },
    writeFile: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.writeFile()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.writeFile, p, arguments); },
    appendFile: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.appendFile()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.appendFile, p, arguments); },
    readdir: function() { const context = getContext(); if (!isReadAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.readdir()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.readdir, p, arguments); },
    stat: function() { const context = getContext(); if (!isReadAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.stat()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.stat, p, arguments); },
    lstat: function() { const context = getContext(); if (!isReadAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.lstat()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.lstat, p, arguments); },
    mkdir: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.mkdir()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.mkdir, p, arguments); },
    rm: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.rm()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.rm, p, arguments); },
    rename: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.rename()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.rename, p, arguments); },
    copyFile: function() { const context = getContext(); if (!isWriteAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.copyFile()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.copyFile, p, arguments); },
    chmod: function() { const context = getContext(); if (!isMetaAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.chmod()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.chmod, p, arguments); },
    chown: function() { const context = getContext(); if (!isMetaAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.chown()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.chown, p, arguments); },
    utimes: function() { const context = getContext(); if (!isMetaAllowed(context.permissions || {})) return Promise.reject(primordials.NewError("using 'fs.promises.utimes()' is not allowed in " + (getContext().id || "unknown"))); return primordials.ReflectApply(p.utimes, p, arguments); },
  });
}

module.exports = Object.freeze(hostFsModule);
`;
}
...
export default Object.freeze(hostFsModule);
`;
}
